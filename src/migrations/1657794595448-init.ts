...
export class Init1657794595448 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "volunteer_request" ("id" int NOT NULL IDENTITY(1,1), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_c94f4850d7481b4a81777bbd16c" DEFAULT getdate(), "name" nvarchar(255) NOT NULL, "audience" int NOT NULL, "isPhysical" bit NOT NULL, "description" nvarchar(500) NOT NULL, "startDate" datetime NOT NULL, "endDate" datetime NOT NULL, "duration" nvarchar(255) NOT NULL, "startTime" datetime NOT NULL, "totalVolunteers" int NOT NULL, "currentVolunteers" int, "status" varchar(255) NOT NULL, "creatorId" nvarchar(255), "language" varchar(255) NOT NULL, CONSTRAINT "PK_volunteer_request" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
