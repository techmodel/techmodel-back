...
import { company1, program1, program2, programCoordinator1, programManager1, volunteer1 } from './mock';
...
describe('user', function() {
  ...
  describe('updateUserInfo', async () => {
    it('returns 400 when volunteer tries to update programId', async () => {
